...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/wwh/kdev_ros/src/test)
  set(test_DEVEL_PREFIX /home/wwh/kdev_ros/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/wwh/kdev_ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wwh/kdev_ros/src/test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wwh/kdev_ros/devel/lib;/home/wwh/test_ro_ws/devel/lib;/home/wwh/qqq/devel/lib;/opt/ros/kinetic/lib)
